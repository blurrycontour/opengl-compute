...
class Engine:
    ...
    def __init__(self, width, height, compute_file='shaders/compute.glsl'):
        """
        ...
        self.shader = self.createShader("shaders/vertex.glsl",
                                        "shaders/fragment.glsl")
        
        self.rayTracerShader = self.createComputeShader(compute_file)
    ...
    def renderScene(self):
        ...
        nX = int(self.screenWidth/32)
        nY = int(self.screenHeight/32)
